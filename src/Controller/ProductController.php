...
class ProductController extends AbstractController
{
    ...
    {
        /**
         * Pour sélectionner des données dans une table SQL, nous avons besoin d'un Repository de l'entité corespondante 
         * Product => 'ProductRepository'. Un Repository est une classe générée par doctrine, elle nous permet de faire des selections (SELECT) 
         * en base de données. Pour ce la elle a à disposition différentes méthodes (find, findByOne, findAll, etc)
         * 
         * Pour pouvoir utiliser le Repository "on l'injecte en dépendance, c'est à dire en paramètre de notre fonction et 
         * c'est le container de service de symfony qui se charge d'instancier la classe pour nous
         */
